...
npx wrangler d1 execute myjobtrack-db --env development --command "SELECT email, businessType, source, createdAt FROM waitlist ORDER BY createdAt DESC LIMIT 3;" --quiet
