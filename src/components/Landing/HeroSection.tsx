...
const HeroSection: React.FC = () => {
  ...
  return (
    <header
      className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 dark:from-blue-950 dark:via-blue-900 dark:to-purple-950 overflow-hidden"
      role="banner"
    >
      {/* Background Pattern */}
          ...
          <div className="text-center md:text-left md:max-w-md">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg leading-tight">
              ...
              <span className="sr-only">
                - MyJobTrack for Landscapers, Handymen, Cleaners & Service
                Professionals
              </span>
            </h1>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <button 
                          ...
                          className="bg-purple-600 hover:bg-purple-700 text-white rounded-lg p-2 text-center col-span-2 transition-colors duration-200"
                        >
